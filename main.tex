...
\setbeamercolor{section in head/foot}{fg= SlateGrey!75, bg=Fuchsia!45}
...
\vspace{2cm}
We will be talking more about JMM in later meetings but if you think you might want to go be aware it will somewhere aroun \$275 which include plane, conference registration, and hotels. (SGA will cover up to 50\% of the travel cost (maxing out at \$3000)) so there is a limit on how many people we can take. 
